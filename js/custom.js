(function ($) {
  ...
  $(document).on("change", ".switch-language-check", function () {
    if ($(this).is(":checked")) {
      loadLanguage("en")
    } else {
      loadLanguage("es")
  ...
  var backendSkills = [
    ...
    {
      titulo: "Nest js",
      imagenURL: "images/skills/nestjs-icon-256x255-r03j160r.png",
    },
    { titulo: "Firebase", imagenURL: "images/skills/firebase.png" },
    { titulo: "PHP", imagenURL: "images/skills/php.png" },
    {
      titulo: "Codeigniter",
      imagenURL: "images/skills/free-codeigniter-4-1175201.png",
    },
  ];
  ...
  var databaseSkills = [
    ...
    {
      titulo: "Mongo DB",
      imagenURL: "images/skills/free-mongodb-5-1175140.png",
    },
  ...
  var toolsSkills = [
    {
      ...
      imagenURL: "images/skills/visualcode.png",
    },
    {
      titulo: "Visual Studio",
      imagenURL: "images/skills/Visual_Studio_Icon_2019.svg.png",
    },
